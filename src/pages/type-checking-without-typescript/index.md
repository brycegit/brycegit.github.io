...
One useful tool is JSDoc's `@typedef` which allows you to create reusable types that can be exported and used across your codebase. Here is a simple example:
